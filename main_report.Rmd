...
inputPanel(
  sliderInput("thresh", label = "Minimum Value for Mean: ",
              min = 0.3, max = 0.8, value = 0.5, step = 0.01),
  sliderInput("sdev", label = "Maximum Value for Std. Deviation: ",
              min = 0, max = 0.15, value = 0.06, step = 0.01),
  checkboxInput("approved", "Filter Drugs?", TRUE),
  checkboxInput("keep", "Plot Filtered Drugs?", TRUE)
)
...
g + geom_hline(yintercept = input$sdev, color = "grey80", lwd = 2) +
